...
import static com.didekin.tutor.crypto.encoding.EncriptionAscii.toHexFromAscii;
import static com.didekin.tutor.crypto.encoding.EncriptionAscii.encryptedHexText_1;
import static com.didekin.tutor.crypto.encoding.EncriptionAscii.fromBinaryToHexInt;
import static com.didekin.tutor.crypto.encoding.EncriptionAscii.getBitsFromAsciiString;
import static com.didekin.tutor.crypto.encoding.EncriptionAscii.getBitsFromInt;
import static com.didekin.tutor.crypto.encoding.EncriptionAscii.getBitsFromHexString;
import static com.didekin.tutor.crypto.encoding.EncriptionAscii.plaintAsciiText_1;
import static com.didekin.tutor.crypto.encoding.EncriptionAscii.xOrFromBinary;
