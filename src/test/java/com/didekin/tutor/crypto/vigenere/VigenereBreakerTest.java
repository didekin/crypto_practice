...
import static com.didekin.tutor.crypto.vigenere.VigenereBreaker.getSubtextByShift;
...
public class VigenereBreakerTest {
    ...
    private static final String coursera_hw_1 =
    ...
    {
        assertThat(getSubtextByShift("5A593A583E", 2), allOf
                (
                        hasItem('Z'),
                        hasItem(':'),
                        hasItem('>')
        ...
        assertThat(getSubtextByShift("5A593A583E", 2).size(), is(3));

        assertThat(getSubtextByShift("5A593A583E", 1).size(), is(5));
    }
    ...
    {
       int period = getKeyPeriodFromText(coursera_hw_1);
       System.out.printf("period = %d", period);
    }
}