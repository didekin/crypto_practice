...
/**
 *  UTXO class represents an unspent transaction output. It contains:
...
public class UTXO implements Comparable<UTXO> {
    ...
    /**
     * Creates a new UTXO corresponding to the output with outputIndexInTx <outputIndexInTx> in the transaction whose
     * hash is {@code txHash}
     */
